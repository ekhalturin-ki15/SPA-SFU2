...
//
//             L"Компетенция", L"ЗЕ Компетенций", L"Кол-во дисциплин
//             компетенции", L"Процент распределения Компетенции",
//
...
//             L"Диаметр графа по расстоянию",
//             L"Диаметр графа по количеству рёбер",
//             L"Количество компонент связности", L"Максимальное оставное
//             дерево", L"Минимальное оставное дерево", L"Плотность графа",
//             L"Количество основных дисциплин", L"Количество дисциплин по
//             выбору", L"Количество факультативов" })
//{
//
// }
//
...
//                                           vector<bool>& arrIsAllowed, const
//                                           vector<wstring>& arrParams)
//{
//     arrReturn.clear();
//     arrIsAllowed.clear();
...
//                     /*std::ostringstream fOut;
//                     fOut <<
//                     std::setprecision(ptrGlobal->ptrConfig->iPrecision)
...
//                   fGraph->dMaxRib, fGraph->dMinRib, fGraph->dDiametrLen,
//                   fGraph->dDiametrStep, double(fGraph->iComponent),
//                   fGraph->dMaxSpanTree, fGraph->dMinSpanTree, fGraph->dDense
//                   };
//
...
// }
//
// void FAdapOutData::CreateSummaryTotalData(vector<vector<string>>&
// arrReturnData,
...
//     vector<vector<string>>& arrReturnData,    // Возвращаемое значение с
//     функции int x, int& iSizeX, int& iCurrentY, FTreeMetric* ptrMetric, int
//     iDeep, const bool& bIsLocal)
//{
//     if (!bIsCounting)
//     {
...
// }
//
// string FAdapOutData::AddCompString(const map<string, vector<string>>&
// mapComp)
//{
//     string sReturn = "(";
//     int    j       = -1;
...
//     for (auto& [key, val] :
//     fTree->ptrGraph->mapGraph[iGraphType].mapReversRel)
//     {
//         string sTag = "-";
