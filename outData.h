...
private:
    ...
    int OutRectAddInfo(int x, int y, FTreeMetric* ptrMetric, bool bIsCourse, const double dAllSum, bool bIsLocal = false);    // Возвращает Актуальное занчение y
